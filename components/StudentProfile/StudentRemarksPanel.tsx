...
import { X, MessageSquareQuote, Plus, CalendarDays, CalendarX, Pencil, Trash2, Info, ChevronDown, ChevronUp, ShieldAlert, CalendarX as CalendarXIcon } from 'lucide-react';
                                ...
                                <div key={uid} className="bg-white rounded-lg border border-slate-100 p-2.5 shadow-sm hover:shadow-md hover:border-blue-100 transition-all group relative">
                                    <div className="flex justify-between items-start mb-2">
                                        <div className="flex flex-col">
                                            ...
                                            <div className="flex items-center text-[8px] text-slate-400 font-bold uppercase tracking-tighter mt-1 pl-7">By {item['Contacted By'] || 'System'}</div>
                                        </div>
                                        <div className="flex items-center space-x-1.5 opacity-0 group-hover:opacity-100 transition-all">
                                            <button onClick={() => onEditFollowup(item)} className="p-1 hover:bg-blue-50 text-blue-400 hover:text-blue-600 rounded"><Pencil className="w-3 h-3" /></button>
                                            <button onClick={() => onDeleteFollowup(item._index)} className="p-1 hover:bg-red-50 text-red-400 hover:text-red-600 rounded"><Trash2 className="w-3 h-3" /></button>
                                        </div>
                                    </div>
